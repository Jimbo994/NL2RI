...
# def predict_nl_from_descriptor(data, model, leverage_matrix, features=None):
#     """
...
#     :param data:
#     :param model:
#     :param leverage_matrix:
#     :param features:
#     :return:
#     """
#     if features == None:
#         features = leverage_matrix.columns[1:]
#     ri = model.predict(data)
#     leverages = np.diag(data.values @ leverage_matrix.values @ data.values)
